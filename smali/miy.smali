...
# direct methods
.method constructor <init>(Lmin;Llzy;)V
    .locals 1
    ...
    iput-object v0, p0, Lmiy;->b:Llzy;

    .line 47
    return-void
.end method

.method private static a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lawy;)V
    .locals 2

    .prologue
    .line 163
    invoke-virtual {p1}, Lawy;->q()[B
...
# virtual methods
.method public final a(Lawy;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    ...
    .line 59
    invoke-virtual {p1}, Lawy;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lawy;->l()Ljava/lang/String;
    ...
    .line 68
    :goto_1
    invoke-static {v2, p2}, Lmiy;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 69
    invoke-virtual {p1}, Lawy;->i()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Lmiy;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    .line 2094
    invoke-virtual {v3}, Laxa;->ordinal()I
    ...
    .line 75
    :goto_2
    invoke-static {v4, v3}, Lmih;->a(Lorg/apache/http/params/HttpParams;I)V

    .line 77
    if-eqz v1, :cond_0

    .line 78
    iget-object v3, p0, Lmiy;->b:Llzy;

    invoke-virtual {v3, v1}, Llzy;->d(Ljava/lang/Object;)V

    .line 3089
    :cond_0
    iget-object v1, p0, Lmiy;->a:Lmin;

    invoke-virtual {v1, v2}, Lmin;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    ...
    invoke-virtual {p1}, Lawy;->p()Ljava/lang/String;
    ...
    .line 1136
    invoke-static {v2, p1}, Lmiy;->a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lawy;)V
    ...
    invoke-direct {v2, v3}, Laxu;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Laxu;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
