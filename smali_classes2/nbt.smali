...
.method public static a(Luxp;)Lnbt;
    .locals 4
    ...
    .line 60
    invoke-virtual {v0, v1}, Lnbt;->f(Landroid/os/Bundle;)V

    .line 62
    return-object v0
.end method

.method private static a([B)Luxp;
    .locals 1
...
.method public final a(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0}, Lnbt;->e()Landroid/content/Context;
    ...
    iput-object v1, p0, Lnbt;->aa:Landroid/support/design/widget/TextInputEditText;

    .line 94
    invoke-virtual {v2, v3}, Labd;->a(Landroid/view/View;)Labd;

    .line 96
    iget-object v1, p0, Lnbt;->ab:Luxp;

    iget-object v1, v1, Luxp;->d:Lvaz;
    ...
    invoke-virtual {v1}, Luxp;->dh_()Landroid/text/Spanned;
    ...
    .line 100
    :cond_0
    iget-object v0, p0, Lnbt;->ab:Luxp;
    ...
    .line 101
    iget-object v0, p0, Lnbt;->aa:Landroid/support/design/widget/TextInputEditText;

    iget-object v1, p0, Lnbt;->ab:Luxp;

    invoke-virtual {v1}, Luxp;->di_()Landroid/text/Spanned;
    ...
    iget-object v1, p0, Lnbt;->Y:Luyt;

    iget-object v3, p0, Lnbt;->ab:Luxp;

    iget-object v3, v3, Luxp;->a:Lwji;

    invoke-direct {v0, v1, v3}, Lmup;-><init>(Luyt;Lwji;)V

    iput-object v0, p0, Lnbt;->Z:Lmup;
    ...
    .line 3042
    iget-object v1, v0, Luxp;->f:Landroid/text/Spanned;
    ...
    iput-object v1, v0, Luxp;->f:Landroid/text/Spanned;

    .line 3046
    :cond_3
    iget-object v0, v0, Luxp;->f:Landroid/text/Spanned;

    .line 112
    new-instance v1, Lnbv;

    invoke-direct {v1, p0}, Lnbv;-><init>(Lnbt;)V
    ...
    .line 3066
    iget-object v3, v1, Luxp;->g:Landroid/text/Spanned;

    if-nez v3, :cond_4

    .line 3067
    iget-object v3, v1, Luxp;->c:Lvaz;
    ...
    iput-object v3, v1, Luxp;->g:Landroid/text/Spanned;

    .line 3070
    :cond_4
    iget-object v1, v1, Luxp;->g:Landroid/text/Spanned;

    .line 121
    new-instance v3, Lnbu;

    invoke-direct {v3, p0}, Lnbu;-><init>(Lnbt;)V
...
.method public final b(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p0}, Lnbw;->a(Lnbt;)V
    ...
    invoke-static {v0}, Lnbt;->a([B)Luxp;

    move-result-object v0

    .line 2153
    iput-object v0, p0, Lnbt;->ab:Luxp;
...
.method public final onEditorAction(Landroid/widget/TextView;ILandroid/view/KeyEvent;)Z
    ...
    .line 144
    invoke-static {p1}, Lmne;->a(Landroid/view/View;)V
