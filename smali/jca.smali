...
.method constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Ljca;->a:Ljava/util/Map;

    iput-object p2, p0, Ljca;->b:Ljava/util/Map;

    iput-object p3, p0, Ljca;->c:Ljava/util/Map;
...
.method public final a(Likf;Ljava/util/Set;Ljava/util/Set;Ljbx;)V
    ...
    invoke-interface {p4}, Ljbx;->c()Ljbv;

    :cond_0
    iget-object v0, p0, Ljca;->c:Ljava/util/Map;
    ...
    iget-object v1, p0, Ljca;->d:Ljava/util/Map;
    ...
    invoke-interface {p4}, Ljbx;->d()Ljbv;
