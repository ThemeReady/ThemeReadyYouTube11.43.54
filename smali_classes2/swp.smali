...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lswp;->g:[J

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lsys;Lmky;Lywq;Lywq;)V
    .locals 1
    ...
    iput-object v0, p0, Lswp;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, Lswp;->j:Landroid/app/NotificationManager;

    .line 64
    new-instance v0, Lswr;

    .line 2358
    invoke-direct {v0, p0}, Lswr;-><init>(Lswp;)V

    .line 64
    invoke-interface {p2, v0}, Lsys;->a(Lsyt;)V
...
.method private final a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    .line 300
    :cond_0
    iget-object v1, p0, Lswp;->a:Landroid/content/Context;
...
.method private final a(Logn;)Landroid/net/Uri;
    .locals 2

    .prologue
    .line 318
    iget-object v0, p0, Lswp;->a:Landroid/content/Context;
    ...
    .line 319
    invoke-virtual {p1, v0}, Logn;->a(I)Logk;
...
.method private final a(ZLjava/lang/String;Ljava/lang/String;Landroid/net/Uri;JJZZZ)V
    ...
    iget-object v3, p0, Lswp;->a:Landroid/content/Context;
    ...
    .line 161
    iget-object v2, p0, Lswp;->a:Landroid/content/Context;
    ...
    invoke-static/range {v2 .. v7}, Lszz;->b(Landroid/content/Context;ZJJ)Ljava/lang/String;
    ...
    .line 178
    iput-object v2, p0, Lswp;->d:Lhk;

    .line 180
    if-eqz p1, :cond_0

    .line 181
    iget-object v2, p0, Lswp;->d:Lhk;
    ...
    iget-object v4, p0, Lswp;->a:Landroid/content/Context;
    ...
    invoke-direct {p0, v5, p2, v6}, Lswp;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3, p2, v4}, Lswp;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    invoke-direct {p0, v3, p2, v0}, Lswp;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    .line 212
    invoke-direct {p0, p4}, Lswp;->b(Landroid/net/Uri;)Z
    ...
    iget-object v2, p0, Lswp;->e:Landroid/util/Pair;
    ...
    invoke-static/range {v2 .. v7}, Lszz;->a(Landroid/content/Context;ZJJ)Ljava/lang/String;
    ...
    .line 9308
    iget-object v5, p0, Lswp;->a:Landroid/content/Context;
...
.method private final b(Landroid/net/Uri;)Z
    ...
    .prologue
    .line 325
    iget-object v0, p0, Lswp;->e:Landroid/util/Pair;
...
.method public final a()V
    ...
    .line 138
    iget-object v0, p0, Lswp;->j:Landroid/app/NotificationManager;
    ...
    .line 139
    iput-object v2, p0, Lswp;->e:Landroid/util/Pair;

    .line 140
    iput-object v2, p0, Lswp;->f:Landroid/net/Uri;
...
.method final a(Landroid/net/Uri;)V
    ...
    .line 242
    invoke-direct {p0, p1}, Lswp;->b(Landroid/net/Uri;)Z
    ...
    .line 11337
    iput-object p1, p0, Lswp;->f:Landroid/net/Uri;

    .line 11338
    iget-object v0, p0, Lswp;->h:Lmky;

    new-instance v1, Lswq;

    invoke-direct {v1, p0}, Lswq;-><init>(Lswp;)V

    invoke-interface {v0, p1, v1}, Lmky;->a(Landroid/net/Uri;Llxj;)V
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Logn;JJZZ)V
    .locals 16
    ...
    invoke-direct {v0, v1}, Lswp;->a(Logn;)Landroid/net/Uri;
    ...
    invoke-direct/range {v3 .. v14}, Lswp;->a(ZLjava/lang/String;Ljava/lang/String;Landroid/net/Uri;JJZZZ)V

    .line 119
    move-object/from16 v0, p0

    invoke-virtual {v0, v7}, Lswp;->a(Landroid/net/Uri;)V

    .line 120
    move-object/from16 v0, p0

    iget-object v2, v0, Lswp;->b:Lywq;
    ...
    invoke-interface {v2}, Lsyu;->e()V

    .line 121
    return-void
.end method

.method public final a(Ljava/lang/String;Ljava/lang/String;Logn;Z)V
    .locals 6
    ...
    .line 130
    invoke-direct {p0, p3}, Lswp;->a(Logn;)Landroid/net/Uri;
    ...
    invoke-direct {p0, v2, p1, p4}, Lswp;->a(Ljava/lang/String;Ljava/lang/String;Z)Landroid/app/PendingIntent;
    ...
    .line 3232
    iput-object v0, p0, Lswp;->d:Lhk;

    .line 3234
    invoke-direct {p0, v1}, Lswp;->b(Landroid/net/Uri;)Z
    ...
    .line 132
    :cond_0
    invoke-virtual {p0, v1}, Lswp;->a(Landroid/net/Uri;)V

    .line 133
    iget-object v0, p0, Lswp;->b:Lywq;
    ...
    invoke-interface {v0, p1}, Lsyu;->a(Ljava/lang/String;)V

    .line 134
    return-void
.end method

.method public final a(Lsyr;)V
    .locals 0

    .prologue
    .line 69
    iput-object p1, p0, Lswp;->c:Lsyr;

    .line 70
    return-void
.end method

.method public final a(ZLjava/lang/String;Ljava/lang/String;Logn;JJZZ)V
    .locals 15
    ...
    invoke-direct {p0, v0}, Lswp;->a(Logn;)Landroid/net/Uri;
    ...
    .line 94
    invoke-virtual {p0, v7}, Lswp;->a(Landroid/net/Uri;)V

    .line 95
    iget-object v2, p0, Lswp;->b:Lywq;
    ...
    .line 96
    invoke-interface/range {v2 .. v7}, Lsyu;->a(Ljava/lang/String;JJ)V
