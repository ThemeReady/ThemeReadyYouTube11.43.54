...
# direct methods
.method public constructor <init>(Ljava/net/HttpURLConnection;Ljava/lang/String;Lylm;Lylk;IILylp;)V
    .locals 5
    ...
    .line 119
    iput-object p1, p0, Lyls;->b:Ljava/net/HttpURLConnection;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p3}, Lylm;->a()Ljava/util/Set;
    ...
    .line 150
    invoke-virtual {p3, v0}, Lylm;->a(Ljava/lang/String;)Ljava/util/List;
...
.method private final f()Lyln;
    ...
    .prologue
    .line 276
    invoke-direct {p0}, Lyls;->h()V

    .line 280
    :try_start_0
    iget-object v0, p0, Lyls;->b:Ljava/net/HttpURLConnection;
    ...
    .line 294
    iget-object v1, p0, Lyls;->b:Ljava/net/HttpURLConnection;
    ...
    .line 302
    invoke-virtual {v3, v0, v1}, Lylm;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v4, v0, v2}, Lyln;-><init>(ILylm;Ljava/io/InputStream;)V
...
.method final a()Lyln;
    ...
    invoke-direct {p0}, Lyls;->f()Lyln;
    :try_end_3
    .catch Lymk; {:try_start_3 .. :try_end_3} :catch_2
    ...
    .line 233
    :try_start_4
    iget-object v7, p0, Lyls;->c:Lylk;

    sub-int v8, v12, v4

    invoke-interface {v7, v6, v4, v8}, Lylk;->a([BII)I

    move-result v7

    .line 234
    iget-wide v8, p0, Lyls;->d:J

    int-to-long v10, v7

    add-long/2addr v8, v10

    iput-wide v8, p0, Lyls;->d:J
    :try_end_4
    ...
    invoke-virtual {v2, p0}, Lymn;->b(Lymj;)V
...
.method public final b()Ljava/util/concurrent/Future;
    ...
    invoke-direct {v1, p0}, Lylt;-><init>(Lyls;)V
