...
.field private synthetic c:Lhss;
...
.method public constructor <init>(Lhss;)V
    ...
    iput-object v0, p0, Lhst;->b:Ljava/io/ByteArrayOutputStream;
...
.method public final a(Lhsl;)Z
    ...
    invoke-virtual {v0, p1, v1}, Lhss;->a(Lhsl;Z)Ljava/lang/String;
    ...
    :cond_2
    iget-object v4, p0, Lhst;->b:Ljava/io/ByteArrayOutputStream;
    ...
    :cond_4
    :try_start_0
    iget-object v0, p0, Lhst;->b:Ljava/io/ByteArrayOutputStream;
    ...
    iget-object v1, p0, Lhst;->c:Lhss;

    const-string v3, "Failed to write payload when batching hits"

    invoke-virtual {v1, v3, v0}, Lhss;->d(Ljava/lang/String;Ljava/lang/Object;)V
