...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ljhw;->ad:Ljava/util/List;
    ...
    iput-object v0, p0, Ljhw;->ae:Ljava/util/List;

    .line 52
    const/4 v0, 0x0

    iput v0, p0, Ljhw;->af:I

    .line 53
    const/4 v0, -0x1

    iput v0, p0, Ljhw;->ag:I
...
.method private final v()V
    ...
    .line 182
    iget-object v1, p0, Ljhw;->ac:Lcom/google/android/gms/cast/MediaInfo;

    .line 8000
    iget-object v1, v1, Lcom/google/android/gms/cast/MediaInfo;->f:Ljava/util/List;

    .line 183
    iget-object v3, p0, Ljhw;->ae:Ljava/util/List;

    invoke-interface {v3}, Ljava/util/List;->clear()V

    .line 184
    iget-object v3, p0, Ljhw;->ad:Ljava/util/List;
    ...
    invoke-direct {v4, v6, v7, v0}, Lhxj;-><init>(JI)V

    const v5, 0x7f11011f

    .line 8172
    invoke-virtual {p0, v5}, Ljhw;->a(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Lhxj;->b(Ljava/lang/String;)Lhxj;
    ...
    .line 8173
    invoke-virtual {v4, v5}, Lhxj;->a(I)Lhxj;
    ...
    .line 8174
    invoke-virtual {v4, v5}, Lhxj;->a(Ljava/lang/String;)Lhxj;

    move-result-object v4

    .line 9000
    iget-object v4, v4, Lhxj;->a:Lcom/google/android/gms/cast/MediaTrack;

    .line 185
    invoke-interface {v3, v4}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 186
    iput v2, p0, Ljhw;->af:I

    .line 187
    const/4 v3, -0x1

    iput v3, p0, Ljhw;->ag:I
    ...
    .line 194
    :pswitch_0
    iget-object v4, p0, Ljhw;->ad:Ljava/util/List;

    invoke-interface {v4, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 195
    iget-object v4, p0, Ljhw;->ab:[J

    if-eqz v4, :cond_1

    .line 196
    iget-object v6, p0, Ljhw;->ab:[J
    ...
    .line 205
    :pswitch_1
    iget-object v4, p0, Ljhw;->ae:Ljava/util/List;
...
.method public final a(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    iget-object v9, p0, Ljhw;->ad:Ljava/util/List;

    iget v10, p0, Ljhw;->af:I

    invoke-direct {v4, v7, v8, v9, v10}, Ljia;-><init>(Landroid/content/Context;ILjava/util/List;I)V

    iput-object v4, p0, Ljhw;->Z:Ljia;
    ...
    iget-object v9, p0, Ljhw;->ae:Ljava/util/List;

    iget v10, p0, Ljhw;->ag:I

    invoke-direct {v4, v7, v8, v9, v10}, Ljia;-><init>(Landroid/content/Context;ILjava/util/List;I)V

    iput-object v4, p0, Ljhw;->aa:Ljia;

    .line 3139
    iget-object v4, p0, Ljhw;->Z:Ljia;

    invoke-virtual {v0, v4}, Landroid/widget/ListView;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 3140
    iget-object v4, p0, Ljhw;->aa:Ljia;
    ...
    .line 3147
    iget-object v8, p0, Ljhw;->ad:Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Ljhw;->a(I)Ljava/lang/String;
    ...
    .line 3159
    iget-object v2, p0, Ljhw;->ae:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Ljhw;->a(I)Ljava/lang/String;
    ...
    invoke-direct {v2, p0}, Ljhz;-><init>(Ljhw;)V
    ...
    invoke-direct {v1, p0}, Ljhx;-><init>(Ljhw;)V
...
.method public final b(Landroid/os/Bundle;)V
    ...
    .line 105
    invoke-static {v0}, Ljij;->a(Landroid/os/Bundle;)Lcom/google/android/gms/cast/MediaInfo;

    move-result-object v0

    iput-object v0, p0, Ljhw;->ac:Lcom/google/android/gms/cast/MediaInfo;
    ...
    iput-object v0, p0, Ljhw;->Y:Ljfs;

    .line 107
    iget-object v0, p0, Ljhw;->Y:Ljfs;

    .line 4888
    iget-object v1, v0, Ljfs;->C:Lhxk;
    ...
    .line 108
    iget-object v0, p0, Ljhw;->ac:Lcom/google/android/gms/cast/MediaInfo;
    ...
    .line 111
    invoke-virtual {p0}, Ljhw;->dismiss()V
