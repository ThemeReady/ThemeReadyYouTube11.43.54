...
.method public static a(Landroid/content/Context;Lylf;)Landroid/content/Intent;
    .locals 3
...
.method private static a(Lylf;[B)Lylf;
    .locals 1

    .prologue
    .line 184
    :try_start_0
    invoke-static {p0, p1}, Lylf;->a(Lylf;[B)Lylf;
    :try_end_0
...
.method public final onCreate()V
    ...
    .line 75
    invoke-interface {v0, p0}, Lrnr;->a(Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;)V
...
.method public final onHandleIntent(Landroid/content/Intent;)V
    ...
    .line 3101
    invoke-static {v2, v1}, Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;->a(Lylf;[B)Lylf;
    ...
    iget-object v2, v0, Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;->h:Lrpe;
    ...
    iget-object v7, v0, Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;->d:Lxgn;
    ...
    .line 4113
    iget-object v2, v2, Lrpe;->a:Ljava/util/Deque;
    ...
    .line 4122
    :cond_1
    invoke-interface {v2, v1}, Lrou;->a(Luey;)Z
    ...
    .line 13069
    iget-object v4, v3, Lrpd;->a:Ljava/lang/String;

    iget v5, v3, Lrpd;->b:I

    iget-object v6, v3, Lrpd;->c:Landroid/app/Notification;

    invoke-virtual {v2, v4, v5, v6}, Landroid/app/NotificationManager;->notify(Ljava/lang/String;ILandroid/app/Notification;)V

    .line 13070
    iget-object v2, v3, Lrpd;->a:Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;->j:Llzy;

    new-instance v3, Lrpg;

    invoke-direct {v3, v1}, Lrpg;-><init>(Luey;)V
    ...
    .line 4248
    :cond_4
    invoke-static {v1}, Lrpd;->a(Luey;)Z
    ...
    .line 4306
    iget-object v11, v9, Luez;->h:Lwrh;

    if-eqz v11, :cond_6

    iget-object v11, v9, Luez;->h:Lwrh;

    iget-object v11, v11, Lwrh;->a:[Lwri;
    ...
    iget-object v11, v11, Lwri;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v11, v12, v0}, Lrpd;->a(Ljava/lang/String;IILandroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .line 4325
    :cond_9
    iget-boolean v8, v9, Luez;->m:Z

    if-eqz v8, :cond_a

    iget-object v8, v1, Luey;->g:[J
    ...
    .line 4459
    iget-object v12, v1, Luey;->b:Luoa;

    invoke-static {v12, v11}, Lrpd;->a(Luoa;Landroid/content/Intent;)V

    .line 4460
    iget-object v12, v1, Luey;->c:Lwji;

    invoke-static {v12, v11}, Lrpd;->a(Lwji;Landroid/content/Intent;)V

    .line 4461
    iget-object v12, v1, Luey;->h:Lwji;
    ...
    invoke-static {v12}, Lylf;->a(Lylf;)[B
    ...
    .line 4462
    :cond_b
    iget-object v12, v1, Luey;->i:Lubd;

    invoke-static {v12, v11}, Lrpd;->a(Lubd;Landroid/content/Intent;)V

    .line 4331
    move-object/from16 v0, p0

    invoke-static {v0, v11}, Lrpd;->b(Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    .line 4330
    iget-object v11, v9, Luez;->d:Lvaz;

    .line 4332
    invoke-static {v11}, Lvbb;->a(Lvaz;)Landroid/text/Spanned;
    ...
    iget-object v11, v9, Luez;->e:Lvaz;
    ...
    iget-object v11, v9, Luez;->g:Lvaz;
    ...
    iget-object v11, v9, Luez;->f:Lvaz;
    ...
    iget-object v2, v9, Luez;->i:Ljava/lang/String;

    .line 7506
    iput-object v2, v8, Lhk;->n:Ljava/lang/String;

    .line 4343
    iget-boolean v2, v9, Luez;->j:Z
    ...
    .line 4263
    iget-object v2, v9, Luez;->n:Ljava/lang/String;
    ...
    .line 10355
    iget-object v3, v1, Luey;->j:Lufa;

    iget-object v3, v3, Lufa;->a:Lwrh;
    ...
    .line 10360
    invoke-static {v2}, Lrpd;->a(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    .line 4271
    :cond_10
    iget-object v2, v1, Luey;->e:[Lufb;

    if-eqz v2, :cond_19

    .line 4272
    iget-object v10, v1, Luey;->e:[Lufb;
    ...
    .line 4274
    iget-object v2, v12, Lufb;->c:Luoa;

    if-nez v2, :cond_12

    iget-object v2, v12, Lufb;->e:Lwji;
    ...
    invoke-static {v2}, Lmpg;->e(Ljava/lang/String;)V
    ...
    .line 11471
    :goto_7
    iget-object v3, v12, Lufb;->c:Luoa;
    ...
    .line 11475
    iget-object v3, v1, Luey;->a:Luez;

    .line 11476
    iget-object v14, v3, Luez;->a:Ljava/lang/String;
    ...
    invoke-static {v3, v13}, Lrpd;->a(Luoa;Landroid/content/Intent;)V

    .line 11478
    iget-object v3, v12, Lufb;->d:Lwji;

    invoke-static {v3, v13}, Lrpd;->a(Lwji;Landroid/content/Intent;)V

    .line 11479
    iget-object v3, v12, Lufb;->e:Lwji;
    ...
    .line 11480
    :cond_13
    iget-object v3, v1, Luey;->i:Lubd;

    invoke-static {v3, v13}, Lrpd;->a(Lubd;Landroid/content/Intent;)V
    ...
    invoke-static {v0, v13}, Lrpd;->c(Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    iget-object v3, v12, Lufb;->a:Lvgn;
    ...
    :goto_b
    iget-object v12, v12, Lufb;->b:Lvaz;

    .line 4285
    invoke-static {v12}, Lvbb;->a(Lvaz;)Landroid/text/Spanned;
    ...
    invoke-static {v0, v13}, Lrpd;->b(Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    invoke-interface {v7, v3}, Lxgn;->a(I)I
    ...
    .line 12375
    :cond_19
    iget-object v2, v1, Luey;->d:Lwji;

    if-eqz v2, :cond_1a

    iget-object v2, v1, Luey;->d:Lwji;

    iget-object v2, v2, Lwji;->D:Lwgb;
    ...
    invoke-static {v0, v2}, Lrpd;->c(Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    iget-object v3, v9, Luez;->a:Ljava/lang/String;
    ...
    invoke-direct {v2, v3, v4, v5}, Lrpd;-><init>(Ljava/lang/String;ILandroid/app/Notification;)V
    ...
    iget-object v2, v0, Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;->a:Loce;
    ...
    invoke-direct {v3, v0, v1}, Lrnq;-><init>(Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;Luhh;)V
    ...
    iget-object v2, v0, Lcom/google/android/libraries/youtube/notification/NotificationProcessingService;->g:Lrof;

    iget-object v3, v1, Lvji;->a:Lvje;

    iget-object v3, v3, Lvje;->a:Lvjg;

    iget-object v3, v3, Lvjg;->c:Ljava/lang/String;

    iget-object v1, v1, Lvji;->a:Lvje;

    iget-object v1, v1, Lvje;->b:Lvjh;

    invoke-interface {v2, v3, v1}, Lrof;->a(Ljava/lang/String;Lvjh;)V
