...
.method public constructor <init>(Ljava/lang/String;ZZ)V
    ...
    .line 53
    iput-boolean v3, p0, Lplv;->c:Z

    .line 54
    iput-boolean v3, p0, Lplv;->d:Z
    ...
    iput-object v0, p0, Lplv;->a:Landroid/media/MediaMuxer;
...
.method public final a(Landroid/media/MediaFormat;)I
    ...
    :cond_2
    :try_start_0
    iget-object v1, p0, Lplv;->a:Landroid/media/MediaMuxer;
...
.method public final a(Landroid/content/Context;Lpmg;)V
    ...
    iget-object v2, p0, Lplv;->b:Ljava/lang/String;

    aput-object v2, v1, v3

    new-instance v2, Lplw;

    invoke-direct {v2, p2}, Lplw;-><init>(Lpmg;)V
...
.method public final a()Z
    ...
    .prologue
    .line 93
    iget-boolean v0, p0, Lplv;->j:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lplv;->i:Z

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lplv;->d:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lplv;->f:Z

    if-eqz v0, :cond_2

    :cond_0
    iget-boolean v0, p0, Lplv;->c:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Lplv;->e:Z
...
.method public final b()Z
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lplv;->a:Landroid/media/MediaMuxer;
...
.method public final d()Z
    ...
    iput-boolean v0, p0, Lplv;->h:Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 162
    :goto_1
    iget-boolean v0, p0, Lplv;->h:Z
