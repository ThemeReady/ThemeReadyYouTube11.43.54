...
.method public final a(Landroid/content/Context;Lnwt;Landroid/view/View;Landroid/view/ViewGroup;Lnyu;Z)Landroid/view/View;
    ...
    .line 1125
    iget-object v0, p2, Lnwt;->i:Lwen;

    .line 35
    invoke-direct {v9, v0}, Lnxd;-><init>(Lwen;)V
    ...
    iput-object v2, v4, Lnxk;->a:Landroid/widget/TextView;

    .line 50
    new-instance v2, Ljava/util/ArrayList;

    .line 2128
    iget-object v5, v9, Lnxd;->a:Ljava/util/List;
    ...
    iput-object v2, v4, Lnxk;->c:Ljava/util/ArrayList;
    ...
    iput-object v2, v4, Lnxk;->b:Landroid/view/ViewGroup;
    ...
    .line 57
    :goto_1
    iget-object v0, v8, Lnxk;->a:Landroid/widget/TextView;

    invoke-virtual {v9}, Lnxd;->a()Ljava/lang/CharSequence;
    ...
    .line 4128
    iget-object v4, v9, Lnxd;->a:Ljava/util/List;
...
.method final a(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/view/LayoutInflater;Lnyu;Ljava/util/List;ZLnyy;)V
    .locals 16
    ...
    invoke-direct/range {v2 .. v9}, Lnxg;-><init>(Lnxf;Landroid/content/Context;Lnyu;Landroid/view/ViewGroup;Landroid/view/LayoutInflater;Ljava/util/List;Z)V
    ...
    .line 103
    iget-object v4, v3, Lnxk;->c:Ljava/util/ArrayList;
    ...
    .line 5037
    iget-object v11, v4, Lnxe;->a:Lwem;

    invoke-virtual {v11}, Lwem;->gt_()Landroid/text/Spanned;

    move-result-object v11

    .line 4142
    invoke-static {v6, v11}, Lmne;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 6033
    iget-object v11, v4, Lnxe;->b:Lnxd;

    .line 6132
    iget-boolean v11, v11, Lnxd;->b:Z
    ...
    .line 4150
    invoke-static {v7, v12}, Lmne;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V
    ...
    .line 7041
    :goto_2
    iget-object v8, v4, Lnxe;->a:Lwem;

    iget-boolean v8, v8, Lwem;->c:Z
    ...
    invoke-direct {v5, v0, v4, v2}, Lnxi;-><init>(Lnyu;Lnxe;Ljava/lang/Runnable;)V
    ...
    .line 111
    iget-object v5, v3, Lnxk;->c:Ljava/util/ArrayList;

    invoke-virtual {v5, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 112
    iget-object v5, v3, Lnxk;->b:Landroid/view/ViewGroup;
    ...
    iget-object v13, v0, Lnyy;->a:Ljava/util/Collection;

    new-instance v14, Lnyz;

    invoke-direct {v14, v8, v11, v12}, Lnyz;-><init>(Landroid/widget/ProgressBar;FF)V
    ...
    :cond_5
    :goto_5
    iget-object v2, v3, Lnxk;->c:Ljava/util/ArrayList;
