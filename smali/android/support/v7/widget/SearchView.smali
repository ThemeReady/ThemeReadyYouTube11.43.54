...
.field public static final HIDDEN_METHOD_INVOKER:Lary;
...
.field private mOnCloseListener:Larz;
...
.field private mOnQueryChangeListener:Lasa;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Lasb;
...
.field private mTouchDelegate:Lase;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lary;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Larr;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Larx;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-static {p1, p2, v0, p3, v6}, Laso;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Laso;
    ...
    invoke-virtual {v1, v2}, Laso;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0, v6}, Laso;->g(II)I
    ...
    invoke-direct {v2, p0}, Lars;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v0, v5}, Laso;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Laso;->e(II)I
    ...
    invoke-virtual {v1, v0, v4}, Laso;->a(II)I
...
.method private addOnLayoutChangeListenerToDropDownAnchorBase()V
    ...
    invoke-direct {v1, p0}, Laru;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Lasg;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Lasg;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    .prologue
    .line 1747
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Lary;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    .line 8048
    iget-object v2, v0, Lary;->a:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_0

    .line 8050
    :try_start_0
    iget-object v0, v0, Lary;->a:Ljava/lang/reflect/Method;
    ...
    .line 8057
    iget-object v2, v0, Lary;->b:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_1

    .line 8059
    :try_start_1
    iget-object v0, v0, Lary;->b:Ljava/lang/reflect/Method;
...
.method private onCloseClicked()V
    ...
    .line 1261
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Larz;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Larz;

    invoke-interface {v0}, Larz;->a()Z
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1436
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lasb;
...
.method private onItemSelected(I)Z
    ...
    .prologue
    .line 1447
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lasb;
...
.method private onSubmitQuery()V
    ...
    .line 1241
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lasa;
...
.method private onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1}, Lary;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1232
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lasa;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Lasg;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 876
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Lase;
    ...
    invoke-direct {v0, v1, v2, v3}, Lase;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mTouchDelegate:Lase;
    ...
    invoke-virtual {v0, v1, v2}, Lase;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lasc;-><init>(Landroid/os/Parcelable;)V
...
.method public setOnCloseListener(Larz;)V
    .locals 0

    .prologue
    .line 558
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Larz;
...
.method public setOnQueryTextListener(Lasa;)V
    .locals 0

    .prologue
    .line 549
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lasa;
...
.method public setOnSuggestionListener(Lasb;)V
    .locals 0

    .prologue
    .line 576
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lasb;
