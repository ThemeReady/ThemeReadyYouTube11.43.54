...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ligb;->a:Landroid/content/ComponentName;
    ...
    sput-object v0, Ligb;->b:Landroid/content/ComponentName;

    return-void
.end method

.method public static a(Lifz;)Landroid/content/Intent;
    .locals 2
    ...
    sget-object v1, Ligb;->a:Landroid/content/ComponentName;

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    move-result-object v0

    invoke-interface {p0}, Lifz;->a()Landroid/os/Bundle;
...
.method public static a(Ligc;)Landroid/content/Intent;
    .locals 2
    ...
    sget-object v1, Ligb;->b:Landroid/content/ComponentName;

    invoke-virtual {v0, v1}, Landroid/content/Intent;->setComponent(Landroid/content/ComponentName;)Landroid/content/Intent;

    move-result-object v0

    invoke-interface {p0}, Ligc;->a()Landroid/os/Bundle;
