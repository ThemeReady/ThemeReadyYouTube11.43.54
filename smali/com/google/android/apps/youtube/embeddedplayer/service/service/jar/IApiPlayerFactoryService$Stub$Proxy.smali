...
# virtual methods
.method public final a(Lgsp;Lgtb;Lgth;Lgtk;Lgsm;Lgsj;Lgtn;Lgss;Lgsy;Lgte;Lgtq;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    .locals 5
    ...
    invoke-interface {p1}, Lgsp;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lgtb;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lgth;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lgtk;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lgsm;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lgsj;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lgtn;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lgss;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lgsy;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lgte;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lgtq;->asBinder()Landroid/os/IBinder;
